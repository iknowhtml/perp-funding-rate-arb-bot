...
- Plans: `plans` (for `docs/plans/` changes)
...
- `docs/plans/.../0002-position-derivation.md` — update plan to use dynamic decimal scaling
...
**Staged changes:**
- `docs/plans/active/.../0002-position-derivation.md` — update plan
