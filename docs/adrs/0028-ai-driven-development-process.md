...
**Artifact**: `docs/plans/active/<roadmap>/<phase>/<plan>.md`
...
- Current META-PLAN example: `docs/plans/implemented/0002-on-chain-pivot/00-feasibility/META-PLAN.md`
- Current PARALLEL-EXECUTION example: `docs/plans/implemented/0002-on-chain-pivot/00-feasibility/PARALLEL-EXECUTION.md`
- Current worktree config: `docs/plans/implemented/0002-on-chain-pivot/00-feasibility/worktree-config.sh`
